...
# INSTRUCCIONES PARA DEPLOYMENT DE AUTENTICACIÓN EN EL VPS
# =========================================================
...
echo "=========================================="
echo ""
echo "ssh reimon@reimon.dev -p 5591"
echo ""
echo "=========================================="
...
echo "scp -P 5591 /home/reimon/greenhouse/backend-websocket-update/server.js reimon@reimon.dev:/tmp/"
echo "scp -P 5591 /home/reimon/greenhouse/backend-websocket-update/.env reimon@reimon.dev:/tmp/"
echo ""
echo "=========================================="
...
echo ""
echo "# Mover archivos (ajustar ruta según tu configuración)"
...
echo ""
echo "# Deberías ver:"
echo "✓ Authentication successful for device: ESP32_GREENHOUSE_01"
echo ""
echo "=========================================="
echo "PASO 5: Verificar desde tu máquina local"
echo "=========================================="
echo ""
...
echo ""
echo "# Probar autenticación HTTP"
echo "cd /home/reimon/greenhouse/backend-websocket-update"
echo "./test-auth.sh"
echo ""
echo "=========================================="
echo "SI NO TIENES ACCESO AL VPS AÚN:"
echo "=========================================="
echo ""
echo "El ESP32 YA está configurado con autenticación."
echo "El sistema seguirá funcionando normalmente hasta que"
