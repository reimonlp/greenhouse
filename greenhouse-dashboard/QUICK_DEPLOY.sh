...
echo "─────────────────────────────────────────────────────────────"
echo ""
echo "scp -P 5591 greenhouse-frontend.tar.gz root@168.181.185.42:/tmp/"
echo ""
...
echo "─────────────────────────────────────────────────────────────"
echo ""
echo "scp -P 5591 vps-setup.sh root@168.181.185.42:/tmp/"
echo ""
read -p "Presiona ENTER cuando hayas ejecutado el comando anterior..."
echo ""
...
echo ""
echo "ssh -p 5591 root@168.181.185.42"
echo ""
